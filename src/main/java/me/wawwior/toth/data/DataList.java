...
public final class DataList extends DataElement implements Iterable<DataElement> {
    ...
    public <T extends DataElement> Optional<T> getAs(int index, Type<T> type) {
        try {
            return Optional.of(type.cast(elements.get(index)));
